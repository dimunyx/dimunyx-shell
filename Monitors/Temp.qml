...
Item {
        ...
        Process {
                ...
                command: [
                        "sh",
                        "-c",
                        "sensors | grep 'Tctl' | awk '{print $2}' | tr -d '+°C'"
                ]
                stdout: SplitParser {
                        onRead: function(data) {
                                var value = parseFloat(data.trim())
                                if (!isNaN(value)) {
                                        root.tempValue = value
                                }
                        }
                }
        ...
        RowLayout {
                ...
                Item {
                        id: tempPctWrap
                        Layout.preferredWidth: root.pctVisible ? tempPct.implicitWidth : 0
                                ...
                                Item {
                                        ...
                                        Canvas {
                                                ...
                                                onPaint: {
                                                        ...
                                                        function val(i) {
                                                                var reversedIdx = (max - 1) - i
                                                                if (reversedIdx < len) return data[reversedIdx]
                                                                return data[len - 1]
                                                        }
                                                        var pts = max + 1
                                                        ctx.beginPath()
